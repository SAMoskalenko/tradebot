...
SECRET_KEY = '&fbxs1p$x-c0m^()pp^vlypkv*6joj169*^ymaw7d%@$pv6^!x'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'tradebot.authentication.CsrfExemptSessionAuthentication',
    ),
...
JWT_AUTH = {
    ...
    'JWT_PAYLOAD_HANDLER': 'tradebot.jwt.jwt_create_payload',
